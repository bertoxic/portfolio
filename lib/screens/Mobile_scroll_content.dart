...
class MobileScrollContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // //               children: [
    // //                 Expanded(
    // //                   child: Container( width: screenSize.width*0.4, height: screenSize.height*0.3,
    // //                     child: Image.asset(
    ...
    // //
    // //                 Expanded(
    // //                   child: Container( padding: EdgeInsets.only(top: screenSize.height*0.02,right: screenSize.height*0.02 ),
